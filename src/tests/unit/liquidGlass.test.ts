...
describe("liquidGlass", () => {
  ...
  it("exposes full-mode constraints required by the PRD", () => {
    ...
    expect(options.refraction).toBe(0);
    expect(options.aberration).toBe(0);
    expect(options.bevelDepth).toBeGreaterThan(0);
    expect(options.bevelWidth).toBeGreaterThan(0);
    expect(options.magnify).toBe(1);
    expect(options.frost).toBe(0.9);
